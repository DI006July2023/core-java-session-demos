package com.bms.bmsspringbootrestjdbctemplatemaven.service;
...
import com.bms.bmsspringbootrestjdbctemplatemaven.dao.AuthorDao;
...
//	@Autowired // if autowired used here , it is feild DI
	...
	@Autowired// if autowired used here , it is constructor DI
				// has become optional from spring 4 version, provided there is only one constructor
