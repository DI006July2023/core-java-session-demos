...
public class BookManagementSystemView {
	...
	public void runMenu() {
		// BookServiceImpl bookServiceImpl = new BookServiceImpl(); // not recomended as
		// the class is not abstracted
		...
		try {
			...
			// log the exception in a LOG file in a proper format
			// let the user know about the exception that has occured in a layman's term
